...
interface AppceleratorIconProps {
  width?: number | string;
...
const AppceleratorIcon: React.FC<AppceleratorIconProps> = ({ 
  width = 24, 
  height = 24, 
  className,
  style 
