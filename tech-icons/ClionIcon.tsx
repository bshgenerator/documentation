...
const ClionIcon: React.FC<ClionIconProps> = ({ 
  width = 24, 
  height = 24, 
  className,
  style 
  ...
  <path fill="url(#c)" d="m120.188 40.559-15.06-30.61-28.425 10.285L47.555 51.25 5.485 91.527l37.949 27.621 47.703-43.02Zm0 0"/>
