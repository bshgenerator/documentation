...
interface QtFrameworkIconProps {
  width?: number | string;
...
const QtFrameworkIcon: React.FC<QtFrameworkIconProps> = ({ 
  width = 24, 
  height = 24, 
  className,
  style 
