...
interface HashicorpVagrantIconProps {
  width?: number | string;
...
const HashicorpVagrantIcon: React.FC<HashicorpVagrantIconProps> = ({ 
  width = 24, 
  height = 24, 
  className,
  style 
