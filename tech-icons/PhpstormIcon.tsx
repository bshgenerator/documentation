...
const PhpstormIcon: React.FC<PhpstormIconProps> = ({ 
  width = 24, 
  height = 24, 
  className,
  style 
  ...
  return (
    ...
    >
      <defs>
    <linearGradient id="a" gradientUnits="userSpaceOnUse" x1="25.8" y1="33.6" x2="33.95" y2="17.31" gradientTransform="rotate(.104) scale(1.21905)">
      <stop offset="0" stop-color="#af1df5"/>
      <stop offset=".21" stop-color="#bc20e4"/>
      <stop offset=".63" stop-color="#dd29b8"/>
      <stop offset="1" stop-color="#ff318c"/>
    </linearGradient>
    <linearGradient id="b" gradientUnits="userSpaceOnUse" x1="1.56" y1="67.23" x2="35.95" y2="21.8" gradientTransform="rotate(.104) scale(1.21905)">
      <stop offset=".02" stop-color="#6b57ff"/>
      <stop offset=".42" stop-color="#b74af7"/>
      <stop offset=".75" stop-color="#ff318c"/>
    </linearGradient>
    <linearGradient id="c" gradientUnits="userSpaceOnUse" x1="89.3" y1="65.79" x2="65.46" y2="9.23" gradientTransform="rotate(.104) scale(1.21905)">
    ...
    <linearGradient id="d" gradientUnits="userSpaceOnUse" x1="74.68" y1="93.59" x2="58.6" y2="70.03" gradientTransform="rotate(.104) scale(1.21905)">
      <stop offset=".02" stop-color="#6b57ff"/>
