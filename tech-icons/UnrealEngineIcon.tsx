...
interface UnrealEngineIconProps {
  width?: number | string;
...
const UnrealEngineIcon: React.FC<UnrealEngineIconProps> = ({ 
  width = 24, 
  height = 24, 
  className,
  style 
