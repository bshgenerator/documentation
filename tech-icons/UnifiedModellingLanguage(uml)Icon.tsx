...
interface UnifiedModellingLanguage(uml)IconProps {
  width?: number | string;
...
const UnifiedModellingLanguage(uml)Icon: React.FC<UnifiedModellingLanguage(uml)IconProps> = ({ 
  width = 24, 
  height = 24, 
  className,
  style 
...
export default UnifiedModellingLanguage(uml)Icon;
