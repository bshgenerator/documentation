...
interface AutodeskShotgridIconProps {
  width?: number | string;
...
const AutodeskShotgridIcon: React.FC<AutodeskShotgridIconProps> = ({ 
  width = 24, 
  height = 24, 
  className,
  style 
