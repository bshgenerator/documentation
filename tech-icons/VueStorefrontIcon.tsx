...
interface VueStorefrontIconProps {
  width?: number | string;
...
const VueStorefrontIcon: React.FC<VueStorefrontIconProps> = ({ 
  width = 24, 
  height = 24, 
  className,
  style 
