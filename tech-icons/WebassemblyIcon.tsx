...
interface WebassemblyIconProps {
  width?: number | string;
...
const WebassemblyIcon: React.FC<WebassemblyIconProps> = ({ 
  width = 24, 
  height = 24, 
  className,
  style 
