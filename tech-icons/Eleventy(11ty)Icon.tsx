...
interface Eleventy(11ty)IconProps {
  width?: number | string;
...
const Eleventy(11ty)Icon: React.FC<Eleventy(11ty)IconProps> = ({ 
  width = 24, 
  height = 24, 
  className,
  style 
