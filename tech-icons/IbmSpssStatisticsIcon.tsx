...
interface IbmSpssStatisticsIconProps {
  width?: number | string;
...
const IbmSpssStatisticsIcon: React.FC<IbmSpssStatisticsIconProps> = ({ 
  width = 24, 
  height = 24, 
  className,
  style 
