...
interface VisualStudioCode(vsCode)IconProps {
  width?: number | string;
...
const VisualStudioCode(vsCode)Icon: React.FC<VisualStudioCode(vsCode)IconProps> = ({ 
  width = 24, 
  height = 24, 
  className,
  style 
