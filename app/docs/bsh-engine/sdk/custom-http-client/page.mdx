...
by default, the SDK uses `fetch` to make requests. see the internal implementation [here](https://github.com/bsh-devsolutions/bshengine.sdk.ts/blob/main/src/client/types.ts).
