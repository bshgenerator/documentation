...
<Cards>
    <Cards.Card 
      ...
      href='https://www.postman.com/altimetry-participant-52635096/bsh-engine/folder/5fnoz46/entity-management'
      target='_blank' />
</Cards>
...
| [GET](/docs/bsh-engine/api/entities/search-entities-by-query) | `/api/entities/:entityName?query` | Search entities by query |
...
| [GET](/docs/bsh-engine/api/entities/count-entities) | `/api/entities/:entityName/count` | Count entities |
| [POST](/docs/bsh-engine/api/entities/count-filtered-entities) | `/api/entities/:entityName/count` | Count filtered entities |
