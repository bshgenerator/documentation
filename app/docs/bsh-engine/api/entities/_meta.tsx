...
export default {
  ...
  'search-entities-by-query': <EndpointTitle method='GET' title='Search by Query'/>,
  ...
  'count-entities': <EndpointTitle method='GET' title='Count'/>,
  'count-filtered-entities': <EndpointTitle method='POST' title='Count Filtered'/>,
